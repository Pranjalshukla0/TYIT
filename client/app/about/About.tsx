  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">KnowledgeHub?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than KnowledgeHub, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of KnowledgeHub, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created KnowledgeHub &ndash; to provide new programmers
          ...
          <br />
          <br />
          At KnowledgeHub, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But KnowledgeHub is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With KnowledgeHub by your side, there&apos;s nothing standing between you
        ...
        <br />
        <span className="text-[22px]">Ovaise and Pranjal&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of KnowledgeHub
        </h5>
        <br />
        <br />
        <br />
